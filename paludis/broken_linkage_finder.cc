...
namespace paludis
{
    template class PALUDIS_VISIBLE WrappedForwardIterator<BrokenLinkageFinder::BrokenPackageConstIteratorTag,
             const std::shared_ptr<const PackageID> >;
    template class PALUDIS_VISIBLE WrappedForwardIterator<BrokenLinkageFinder::BrokenFileConstIteratorTag,
             const FSPath>;
